...
from AimXchat import CHATBOT
from AimXchat.modules.helpers import CHATBOT_ON, is_admins


@CHATBOT.on_message(filters.command(["chatbot"]) & filters.group & ~filters.bot)
@is_admins
